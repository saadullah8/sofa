...
<body>
    ...
    <div class="dashboard-main-wrapper">
        ...
        <div class="dashboard-header">
            <nav class="navbar navbar-expand-lg bg-white fixed-top">
                <a class="navbar-brand" href="index.html">Sofa Shop</a>
                        ...
                        <li class="nav-item dropdown nav-user">
                            ...
                            <div class="dropdown-menu dropdown-menu-right nav-user-dropdown"
                             ...
                             <a href="{{ route('logout') }}"
                                    ...
                                    class="items-center"><i class="flaticon-logout mr15"></i>Logout</a>
 ...
 <!-- Size -->
                        <li class="nav-item">
                            <a class="nav-link"@if ($active=='size' ) active
                                
                            @endif href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-1" aria-controls="submenu-1"><i class="fa fa-fw fa-user-circle"></i>Size <span class="badge badge-success">6</span></a>
                            <div id="submenu-1" class="collapse submenu">
                                <ul class="nav flex-column">
                                    <li class="nav-item"><a class="nav-link" href="{{ url('admin/size/index') }}">View All</a></li>
                                    <li class="nav-item"><a class="nav-link" href="{{ url('admin/size/create') }}">Add</a></li>
                                </ul>
                            </div>
                        </li>
...
<li class="nav-item">
    ...
    <a class="nav-link @if ($active=='color') active @endif"
       ...
       data-target="#submenu-color"

       aria-controls="submenu-color">

       <i class="fa fa-fw fa-paint-brush"></i> Color

       <span class="badge badge-success">6</span>

    </a>

    <div id="submenu-color" class="collapse submenu">

        <ul class="nav flex-column">

            <li class="nav-item">

                <a class="nav-link" href="{{ url('admin/color/index') }}">View All</a>

            </li>

            <li class="nav-item">

                <a class="nav-link" href="{{ url('admin/color/create') }}">Add</a>
...
<!-- Stuff -->
<li class="nav-item">
    <a class="nav-link @if ($active=='stuff') active @endif"
       href="#"
       data-toggle="collapse"
       aria-expanded="false"
       data-target="#submenu-stuff"
       aria-controls="submenu-stuff">
       <i class="fa fa-fw fa-paint-brush"></i> Stuff
       <span class="badge badge-success">6</span>
    </a>
    <div id="submenu-stuff" class="collapse submenu">
        <ul class="nav flex-column">
            <li class="nav-item">
                <a class="nav-link" href="{{ url('admin/stuff/index') }}">View All</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="{{ url('admin/stuff/create') }}">Add</a>
            </li>
        </ul>
    </div>
</li>
...
<!-- catagiry-->
<li class="nav-item">
    <a class="nav-link @if ($active=='category') active @endif"
       href="#"
       data-toggle="collapse"
       aria-expanded="false"
       data-target="#submenu-category"
       aria-controls="submenu-category">
       <i class="fa fa-fw fa-paint-brush"></i> Category
       <span class="badge badge-success">6</span>
    </a>
    <div id="submenu-category" class="collapse submenu">
        <ul class="nav flex-column">
            <li class="nav-item">
                <a class="nav-link" href="{{ url('admin/category/index') }}">View All</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="{{ url('admin/category/create') }}">Add</a>
            </li>
        </ul>
    </div>
</li>
...
<!-- subcatgory -->
<li class="nav-item">
    <a class="nav-link @if ($active=='subcategory') active @endif"
       href="#"
       data-toggle="collapse"
       aria-expanded="false"
       data-target="#submenu-subcategory"
       aria-controls="submenu-subcategory">
       <i class="fa fa-fw fa-paint-brush"></i> subcategory
       <span class="badge badge-success">6</span>
    </a>
    <div id="submenu-subcategory" class="collapse submenu">
        <ul class="nav flex-column">
            <li class="nav-item">
                <a class="nav-link" href="{{ url('admin/subcategory/index') }}">View All</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="{{ url('admin/subcategory/create') }}">Add</a>
            </li>
        </ul>
    </div>
</li>
<!-- product -->
<li class="nav-item">
    <a class="nav-link @if ($active=='product') active @endif"
       href="#"
       data-toggle="collapse"
       aria-expanded="false"
       data-target="#submenu-product"
       aria-controls="submenu-product">
       <i class="fa fa-fw fa-paint-brush"></i> Product
       <span class="badge badge-success">6</span>
    </a>
    <div id="submenu-product" class="collapse submenu">
        <ul class="nav flex-column">
            <li class="nav-item">
                <a class="nav-link" href="{{ url('admin/product/index') }}">View All</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="{{ url('admin/product/create') }}">Add</a>
            </li>
        </ul>
    </div>
</li>
<li class="nav-item">
    <a class="nav-link @if ($active=='contact') active @endif"
       href="#"
       data-toggle="collapse"
       aria-expanded="false"
       data-target="#submenu-9"
       aria-controls="submenu-9">
       <i class="fa fa-fw fa-paint-brush"></i> Contact
       <span class="badge badge-success">6</span>
    </a>
    <div id="submenu-9" class="collapse">
        <ul class="nav flex-column">
            <li class="nav-item">
                <a class="nav-link" href="{{ route('contact.index') }}">View All</a>
            </li>
        </ul>
    </div>
</li>
...
<li class="nav-item">
    <a class="nav-link @if ($active=='review') active @endif"
       href="#"
       data-toggle="collapse"
       aria-expanded="false"
       data-target="#submenu-10"
       aria-controls="submenu-10">
       <i class="fa fa-fw fa-paint-brush"></i> Review
       <span class="badge badge-success">6</span>
    </a>
                                    ...
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="#"
                                                    class="breadcrumb-link">Sofa Shop Dashboard</a></li>
